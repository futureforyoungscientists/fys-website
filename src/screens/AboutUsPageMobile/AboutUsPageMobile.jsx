      ...
      <div className="div">
        ...
        <div className="founders">
          <div className="overlap">
            <div className="text-wrapper-4">founders</div>
            <div className="overlap-group-2">
              <div className="sample-person">
                <div className="text-wrapper-5">Tester Singh</div>
                <img className="profile-pic" alt="Profile pic" src="/img/profile-pic-1-1.png" />
        ...
        <div className="team-nebula">
          <div className="overlap-2">
            ...
            <div className="overlap-group-2">
              <div className="sample-person">
                <div className="text-wrapper-5">Tester Singh</div>
                <img className="profile-pic" alt="Profile pic" src="/img/profile-pic-1-6.png" />
                <p className="lorem-ipsum-dolor">
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et
                  dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut
                  aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum
